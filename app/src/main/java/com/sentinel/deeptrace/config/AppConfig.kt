...
import com.sentinel.deeptrace.ui.theme.SentinelTurquoise
...
object AppConfig {
    ...
    object Thresholds {
        const val SCORE_SQUEEZE = 8.5   // Ab hier SentinelTurquoise (Maximum Strength)
        ...
        // Alles darunter ist SentinelRed (Kritisch/Strukturbruch)
    }
